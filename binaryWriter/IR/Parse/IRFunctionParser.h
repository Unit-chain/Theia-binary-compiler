...
///@struct IRFunction
///@brief Structure for Parse function representation
///@var name - function name
///@var commands contains parsed commands with their arguments and flags
///@var attributes contains function arguments
struct IRFunction {
    uint64_t offset;
    std::string name;
...
///@brief parse raw Parse data into functions and instructions inside
///@param fileData it's raw Parse data
std::vector<IRFunction> getFnLines(std::string &fileData) {
    std::vector<IRFunction> tokens;
